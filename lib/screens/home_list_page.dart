...
class _HomeListPageState extends State<HomeListPage> with TickerProviderStateMixin {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          (
            ...
            child: Padding(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(AppLocalizations.of(context).shop_title,style: const TextStyle(fontFamily: 'ReadexRegular'),),
                  const SizedBox(height: 5,),
                  Text(AppLocalizations.of(context).shop_description,style: const TextStyle(fontFamily: 'ReadexLight'))
                ],
              ),
            ),
          )),
          ...
          children: [
            Text(AppLocalizations.of(context).trending_book,style: const TextStyle(fontFamily: 'ReadexBold')),
            Text(AppLocalizations.of(context).view_all,style: const TextStyle(fontFamily: 'ReadexRegular'))],)),
          bookList(),
          bookList(),
        ],
      )
    ...
    return Expanded(
      flex: 5,
        child: ListView.separated(
          ...
          context,
          MaterialPageRoute(
            builder: (context) => BookDetailPage(booklist: booklist[index],),
          ),
        );
            },
            child: Column(
              ...
              children: [
                ...
                child: SizedBox(
                    ...
                    child: Image.network(booklist[index]['imageLink'])
                ),
              ),
